...
async def get_info(data: Data):
    print("Received payload:", data.cv_text)
    ...
    prompt_template = ChatPromptTemplate.from_messages(
        [
            ("system",
             "You are the skills extractor of a recruiting system. Your job consists of taking a resume in a block of text format, extract and organize the information in a json format."),
